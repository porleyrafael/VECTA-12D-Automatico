# Script para crear vector_12d.py correctamente
import os

# El código nuevo completo
codigo_nuevo = '''"""
...
# Guardar el archivo
ruta_archivo = os.path.join("dimensiones", "vector_12d.py")

with open(ruta_archivo, "w", encoding="utf-8") as archivo:
    archivo.write(codigo_nuevo)

print(f"✅ Archivo guardado en: {ruta_archivo}")
print(f"📏 Tamaño: {len(codigo_nuevo)} bytes")

# Verificar que se guardó
if os.path.exists(ruta_archivo):
    tamano = os.path.getsize(ruta_archivo)
    print(f"📁 Verificado: {tamano} bytes")
else:
