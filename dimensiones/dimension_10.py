"""
DIMENSION 10 - CONSCIENCIA REFLEXIVA
Autoconocimiento y metacognicion del sistema
"""
...
class Dimension10(DimensionBase):
    def __init__(self):
        super().__init__(
            numero=10,
            nombre="Consciencia Reflexiva",
            descripcion="Autoconocimiento y metacognicion del sistema"
        )
    ...
    def procesar(self, contexto: Dict[str, Any]) -> ResultadoDimension:
        try:
            ...
            print(f"Error en Dimension 10: {e}")
