"""
DIMENSION 9 - INFORMACION/ENTROPIA
Relacion entre orden y caos, informacion y ruido
"""
...
class Dimension9(DimensionBase):
    def __init__(self):
        super().__init__(
            numero=9,
            nombre="Informacion/Entropia",
            descripcion="Relacion entre orden y caos, informacion y ruido"
        )
    ...
    def procesar(self, contexto: Dict[str, Any]) -> ResultadoDimension:
        try:
            ...
            print(f"Error en Dimension 9: {e}")
